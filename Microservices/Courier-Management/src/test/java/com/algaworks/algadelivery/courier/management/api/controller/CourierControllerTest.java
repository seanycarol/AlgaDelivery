...
class CourierControllerTest {
    ...
    @Test
    void shouldCreateCourierAndReturn201() {
        String requestBody = """ 
            {
                "name": "João da Silva",
                "phone": "1195500050"
    ...
    @Test
    void shouldRetrieveCourierByIdAndReturn200() {
        UUID courierId = courierRepository.saveAndFlush(
                Courier.brandNew("Maria Oliveira", "119875481")
        ).getId();
        ...
        RestAssured
            ...
            .then()
                ...
                .body("name", Matchers.equalTo("Maria Oliveira"))
                .body("phone", Matchers.equalTo("119875481"));
